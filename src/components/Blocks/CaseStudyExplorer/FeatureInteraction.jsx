...
function FeatureInteraction({ onFeatureSelect, hideFilters, ol }) {
  ...
  // directly to that feature. Recreating it (or clearing/refilling the points
  // source) clears that collection and restores the feature's original style,
  // so it must be created exactly once.
